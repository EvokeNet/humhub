                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <strong>
                                        ...
                                        <?php if($membership->space->is_team): ?>
                                            - <?= Yii::t('TeamsModule.widgets_views_spaceChooser', 'Team') ?>
                                        <?php endif; ?>
                                    </strong>
                                    <?php if ($newItems != 0): ?>
        ...
        <?php if ($canCreateSpace): ?>
            <li>
                <div class="dropdown-footer">
                    <?php
                    echo Html::a(Yii::t('SpaceModule.widgets_views_spaceChooser', 'Create new space'), Url::to(['/teams/create/create']), array('class' => 'btn btn-info col-md-12', 'data-target' => '#globalModal'));
                    ?>
                </div>
            </li>
        <?php endif; ?>
