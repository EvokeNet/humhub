  ...
  <div class="row">
      ...
      <div class="col-xs-5 layout-sidebar-container">
        <div class="panel panel-default">
          ...
          <div class = "panel-body">
            <span style = "font-size: 12pt;"><?php echo Yii::t('MatchingModule.base', "Over the next 16 weeks you will be asked to respond to the urgent challenge of LITERACY in your country. You have been selected because of your unique potential to change the world. You have some powers there is no doubt, but you will need to increase your powers to realize your potential. I have asked one of our best agents -- Andre -- to share his story and guide you on this journey.") ?></span><br /><br />

            <span style = "font-size: 12pt;"><?php echo Yii::t('MatchingModule.base', "Over the course of the next 16 weeks you will form a team to create your unique world changing idea or as we call it in the Evoke network. Your Evokation, or unique solution to the problem, will be created as you respond to the 8 missions. At the end of the journey, the network will invest Evocoin in your Evokations. The 10 Evokations with the most investment will be reviewed by experts in my network and the top 3 will receive recognition and reward. As a team you must complete all 6 activities for each mission to advance to the next mission. By completing activities, your powers will increase.") ?></span><br /><br />

            <span style = "font-size: 12pt;"><?php echo Yii::t('MatchingModule.base', "You will also earn Evocoin -- the currency of the Evoke network -- each time you contribute to the quality of our collective thought by giving power to others and commenting on their contributions. Evocoin will be used at the end of your journey to invest in those world changing ideas that you think will have the greatest impact on your community, your country, the world. ") ?></span><br /><br />
            ...
            <span style = "font-size: 12pt;"><?php echo Yii::t('MatchingModule.base', "Good luck agents. I look forward to checking in on your progress and recognizing your final Evokations at the end of this journey.") ?></span><br /><br />
          </div>
        </div>
      </div>
  </div>
