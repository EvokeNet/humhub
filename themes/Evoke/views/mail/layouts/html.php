...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body style="font-size:12px; font-family:Open Sans, Arial,Tahoma, Helvetica, sans-serif; background-color:#ededed">
        ...
        <table height="100%" width="100%" id="mainStructure" border="0" cellspacing="0" cellpadding="0" style="background-color:#ededed;">
            ...
            <!-- START VIEW HEADER -->
            <tr>
                <td align="center" valign="top" style="background-color:#254054">
                    ...
                    <table width="600" align="center" border="0" cellspacing="0" cellpadding="0" class="container" bgcolor="<?php echo Setting::Get('colorPrimary'); ?>"
                           style="background-color:#254054">
                        <tr>
                            <td valign="top">

                                <table width="560" align="center" border="0" cellspacing="0" cellpadding="0" class="full-width"
                                       bgcolor="<?php echo Setting::Get('colorPrimary'); ?>" style="background-color:#254054">
                                    <!-- start space -->
                                    <tr>
                                                                            ...
                                                                            <td style="font-size: 12px; line-height: 27px; font-family:Open Sans, Arial,Tahoma, Helvetica, sans-serif; color:#ffffff; font-weight:300; text-align:center;">
                                                                                <span
                                                                                    style="text-decoration: none; color: #ffffff;"><a
                                                                                        ...
                                                                                        style="text-decoration: none; font-size: 20pt; line-height: 27px; font-family:Open Sans, Arial,Tahoma, Helvetica, sans-serif; color:#ffffff; font-weight:600; text-align:center; text-transform:uppercase;"><?php echo Html::encode(Yii::$app->name); ?></a></span>
