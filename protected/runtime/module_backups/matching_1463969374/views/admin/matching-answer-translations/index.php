...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <?php echo Html::a(Yii::t('MatchingModule.base', 'Create new Translation'), ['create-matching-answer-translations', 'id' => $matching_answer->id], array('class' => 'btn btn-success')); ?>
