...
$this->params['breadcrumbs'][] = ['label' => Yii::t('MatchingModule.base', 'Superhero Identities'), 'url' => ['index-superhero-identities']];
$this->params['breadcrumbs'][] = $superhero_identity->name;
$this->params['breadcrumbs'][] = ['label' => Yii::t('MatchingModule.base', 'Superhero Identity Translation'), 'url' => ['index-superhero-identity-translations', 'id' => $superhero_identity->id]];
