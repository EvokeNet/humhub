...
$this->title = Yii::t('MatchingModule.base', 'Update Matching Question Translation');
...
$this->params['breadcrumbs'][] = ['label' => Yii::t('MatchingModule.base', 'Translations'), 'url' => ['index-matching-question-translations', 'id' => $model->matching_question_id]];
