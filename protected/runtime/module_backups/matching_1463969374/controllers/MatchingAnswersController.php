...
use app\modules\matching_questions\models\MatchingAnswersSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * MatchingAnswersController implements the CRUD actions for MatchingAnswers model.
 */
class MatchingAnswersController extends Controller
{
    /**
     * @inheritdoc
     */
