...
use Yii;
use app\modules\superhero_identity\models\MatchingQuestions;
use app\modules\superhero_identity\models\MatchingQuestionsSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * MatchingController implements the CRUD actions for MatchingQuestions model.
 */
