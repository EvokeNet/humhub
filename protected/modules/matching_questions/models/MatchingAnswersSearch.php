...
/**
 * MatchingAnswersSearch represents the model behind the search form about `app\modules\matching_questions\models\MatchingAnswers`.
 */
class MatchingAnswersSearch extends MatchingAnswers
{
    ...
    {
        return [
            [['id', 'matching_question_id', 'social_innovator_quality_id'], 'integer'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'social_innovator_quality_id' => $this->social_innovator_quality_id,
