...
$this->params['breadcrumbs'][] = ['label' => Yii::t('MatchingQuestionsModule.base', 'Qualities'), 'url' => ['index-qualities']];
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <?php echo Html::a(Yii::t('MatchingQuestionsModule.base', 'Create new Translation'), ['create-quality-translations', 'id' => $quality->id], array('class' => 'btn btn-success')); ?>
        ...
        <?php else: ?>
            ...
            <p><?php echo Yii::t('MatchingQuestionsModule.base', 'No quality translations created yet!'); ?></p>
