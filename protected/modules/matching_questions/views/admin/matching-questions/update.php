...
$this->title = Yii::t('MatchingQuestionsModule.base', 'Update Matching Questions');
$this->params['breadcrumbs'][] = ['label' => Yii::t('MatchingQuestionsModule.base', 'Matching Questions'), 'url' => ['index']];
$this->params['breadcrumbs'][] = Yii::t('MatchingQuestionsModule.base', 'Matching Question').' '.$model->id_code;
