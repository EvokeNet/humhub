...
$this->title = Yii::t('MatchingQuestionsModule.base', 'Create Matching Question Translation');
...
$this->params['breadcrumbs'][] = ['label' => Yii::t('MatchingQuestionsModule.base', 'Translations'), 'url' => ['index-matching-question-translations', 'id' => $matching_question->id]];
