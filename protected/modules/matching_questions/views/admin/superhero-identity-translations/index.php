...
$this->params['breadcrumbs'][] = ['label' => Yii::t('MatchingQuestionsModule.base', 'Superhero Identities'), 'url' => ['index-superhero-identity-translations']];
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <?php echo Html::a(Yii::t('MatchingQuestionsModule.base', 'Create new Translation'), ['create-superhero-identity-translations', 'id' => $superhero_identity->id], array('class' => 'btn btn-success')); ?>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php echo Html::a(
                                ...
                                'data' => [
                                    'confirm' => Yii::t('MatchingQuestionsModule.base', 'Are you sure you want to delete this translation?'),
                                    'method' => 'post',
                                ],
                                )); ?>
                        </td>
        ...
        <?php else: ?>
            ...
            <p><?php echo Yii::t('MatchingQuestionsModule.base', 'No superhero identity translations created yet!'); ?></p>
