...
$this->title = Yii::t('MatchingQuestionsModule.base', 'Create new Matching Answer');
...
$this->params['breadcrumbs'][] = ['label' => Yii::t('MatchingQuestionsModule.base', 'Matching Answers'), 'url' => ['index-matching-answers', 'id' => $matching_question->id]];
