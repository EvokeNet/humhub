...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <div style="position: absolute; top: 10px; right: 10px;"><?php echo Html::a(Yii::t('MatchingModule.base', 'Create new Matching Answer'), ['create-matching-answers', 'id' => $matching_question->id], array('class' => 'btn btn-success')); ?></div>
