...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3><?php echo Yii::t('MatchingModule.base', 'Superhero Identities'); ?></h3>
    </div>
    <div class="panel-body">

        <div style="position: absolute; top: 10px; right: 10px;"><?php echo Html::a(Yii::t('MatchingModule.base', 'Create new Superhero Identity'), ['create-superhero-identities'], array('class' => 'btn btn-success')); ?></div>
        ...
        <?php if (count($identities) != 0): ?>
            ...
            <table class="table">
                <tr>
                    ...
                    <th><?php echo Yii::t('MatchingModule.base', 'Primary Quality'); ?></th>
                    <th><?php echo Yii::t('MatchingModule.base', 'Secondary Quality'); ?></th>
                    <th><?php echo Yii::t('MatchingModule.base', 'Primary Power'); ?></th>
                    <th><?php echo Yii::t('MatchingModule.base', 'Secondary Power'); ?></th>
                    <th>&nbsp;</th>
                </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php echo Html::a(
                                ...
                                'data' => [
                                    'confirm' => Yii::t('MatchingModule.base', 'Are you sure you want to delete this superhero identity?'),
                                    'method' => 'post',
                                ],
                                )); ?>
                        </td>
        ...
        <?php else: ?>
            ...
            <p><?php echo Yii::t('MatchingModule.base', 'No superhero identity created yet!'); ?></p>
