...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <?php echo Html::a(Yii::t('MissionsModule.base', 'Create new Evokation Category Translation'), ['create-category-translations', 'id' => $category->id], array('class' => 'btn btn-success')); ?>
