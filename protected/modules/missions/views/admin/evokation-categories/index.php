...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <div style="position: absolute; top: 10px; right: 10px;"><?php echo Html::a(Yii::t('MissionsModule.base', 'Create new Evokation Category'), ['create-categories'], array('class' => 'btn btn-success')); ?></div>
