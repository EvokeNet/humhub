...
$this->title = Yii::t('MissionsModule.base', 'Add new Power');
...
$this->params['breadcrumbs'][] = ['label' => Yii::t('MissionsModule.base', 'Activity Powers'), 'url' => ['index-activity-powers', 'id' => $activity->id]];
