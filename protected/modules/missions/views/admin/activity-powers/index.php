...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <div style="position: absolute; top: 10px; right: 10px;"><?php echo Html::a(Yii::t('MissionsModule.base', 'Add new Power'), ['create-activity-powers', 'id' => $activity->id], array('class' => 'btn btn-success')); ?></div>
