 ...
 * @since 0.11
 */
class EvokationVotingStream extends \yii\base\Widget
{
    ...
    public function run()
    {
        return $this->render('stream_evokation_voting', array('streamUrl' => $this->getStreamUrl(), 'showFilters' => $this->showFilters, 'filters' => $this->filters));
    }
